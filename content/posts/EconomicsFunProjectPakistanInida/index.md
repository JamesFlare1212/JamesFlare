...
We are learn Economic Indicators in lessons. But do those indicators show how these countries should be?

## As a Economist

### Data

Here is a table that compares some of the indicators between India and Pakistan:

| Indicator | India | Pakistan |
|-----------|-------|----------|
| GNI per capita (2019) | $6,681[^7] | $5,240[^7] |
| HDI (2020) | 0.645[^8] | 0.557[^8] |
| IGDI (2018) | 0.524[^9] | 0.386[^9] |
| GII (2022) | 46th[^11] | 90th[^11] |
...
Addtional: [^12] [^13] [^14] [^15] [^16] [^17] [^18] [^19]
...
This table compares various indicators between India and Pakistan as of the latest available data:

- **GNI per capita:**
  - **India has a higher GNI** (Gross National Income) per capita than Pakistan in 2019.
  - India's GNI per capita was $6,681, while Pakistan's GNI per capita was $5,240.
  - **In Similar**

- **HDI:** 
  - As of 2020, **India has a higher HDI** than Pakistan.
  - India's HDI was 0.645, while Pakistan's HDI was 0.557.
  - **In Similar**

- **IGDI:**
  - As of 2018, **India has a higher IGDI** than Pakistan.
  - India's IGDI was 0.524, while Pakistan's IGDI was 0.386.
  - **A Gap**

- **GII:**
  - As of 2022, India ranks 46th in the world in terms of gender equality, while Pakistan ranks 90th.
  - **A Big Gap**

Overall, India appears to have a **slight advantage** over Pakistan in terms of these development indicators, although both countries have room for improvement.
